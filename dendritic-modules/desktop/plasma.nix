...
# KDE Plasma 6 with XDG Desktop Portal configuration
{pkgs, ...}: {
  # ============================================================================
  ...
  # ============================================================================
  # XDG DESKTOP PORTAL - DRY configuration
  # ============================================================================
  ...
  xdg.portal = {
    ...
    # This ensures that for each portal type, system tries kde first, then falls back to gtk
    config = {
      common = {
