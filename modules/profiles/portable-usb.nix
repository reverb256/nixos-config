{
  ...
  # The standalone image has no declared model input. Keep the optional Bonsai
  # service disabled rather than importing a host-only /models path during pure
  # flake evaluation; add a packaged model input before enabling it.
