...
in {
  programs.niri.settings = {
    ...
    keybinds = {
      ...
      "${mod}+Shift+Print" = {spawn = ["${pkgs.grim}/bin/grim" "- | ${pkgs.wl-clipboard}/bin/wl-copy"];};
      "${mod}+Shift+E" = {spawn = ["${pkgs.code}/bin/code"];};
      ...
      "${mod}+BracketLeft" = {focus-workspace-down = [];};  # Alt-Tab style
      ...
      "${mod}+P" = {toggle-window-rule = "floating";};
      ...
      "${mod}+Ctrl+Space" = {toggle-keyboard-focus = [];};
