...
in {
  programs.zen-browser = {
    ...
    profiles.default = {
      ...
      # Zen preferences extracted to separate file for readability.
      # Read at eval time via builtins.readFile (rebuilds only when prefs change).
      extraConfig = builtins.readFile ./zen-browser-prefs.nix;
