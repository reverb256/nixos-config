...
in {
  ...
  config = mkIf cfg.enable {
    ...
    # ========================================================================
    services.tailscale = mkIf cfg.enableTailscaleSSH {
      enable = true;
    ...
    # ========================================================================
    services.openssh = mkIf cfg.enableTailscaleSSH {
      settings = {
    ...
    # ========================================================================
    services.fail2ban = mkIf cfg.enableTailscaleSSH {
      enable = true;
      jails.sshd = {
        enabled = true;
        filter = "sshd";
    ...
    boot.kernel.sysctl."net.ipv4.conf.default.log_martians" = 1;
  };
}
