    ...
    - Match the exact structure specified'''
        ...
        class AnthropicMessageTranslator:
            ...
            def anthropic_to_openai(body: Dict[str, Any]) -> Tuple[Dict[str, Any], Dict[str, Any]]:
                ...
                # Map Claude model names to local models if needed
                anthropic_model = body.get("model", "")
                if anthropic_model.startswith("claude-"):
                    # Map Claude models to local equivalents
                    model_mapping = {
                        "claude-sonnet-4-20250514": "qwen3.5-35b-a3b@q4_k_m",  # Largest context
                        "claude-sonnet-4-20250514-simplified": "qwen3.5-4b",
                        "claude-haiku-4-20250514": "qwen3.5-2b",
                    }
