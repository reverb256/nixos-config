...
class SearXNGHealthChecker:
    ...
    def __init__(self, searxng_url: str = "http://searxng.search.svc.cluster.local:8080"):
...
def get_health_checker(searxng_url: str = "http://searxng.search.svc.cluster.local:8080") -> SearXNGHealthChecker:
