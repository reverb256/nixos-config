...
class KnowledgeFabricConfig(BaseSettings):
    ...
    searxng_url: str = Field(default="http://searxng.search.svc.cluster.local:7777", description="SearXNG URL")
    mcp_url: str = Field(
...
class MiddlewareConfig(BaseSettings):
    ...
    def override_knowledge_fabric_from_env(self):
        ...
        searxng_url = os.environ.get(
            "MIDDLEWARE__KNOWLEDGE_FABRIC__SEARXNG_URL", "http://searxng.search.svc.cluster.local:7777"
        )
