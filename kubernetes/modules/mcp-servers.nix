        ...
        ingress = [
          {
            ...
            ports = [
              { protocol = "TCP"; port = 8000; }  # grafana-mcp, qdrant-mcp
              { protocol = "TCP"; port = 8080; }  # kubernetes-mcp
              { protocol = "TCP"; port = 9001; }  # searxng-mcp
              { protocol = "TCP"; port = 9003; }  # lightpanda-mcp
              { protocol = "TCP"; port = 9004; }  # nixos-cluster-mcp
              { protocol = "TCP"; port = 9005; }  # casdoor-mcp
            ];
          }
        ];
      };
