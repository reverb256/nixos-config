...
>>>>>>> central/issue-291-audit-remediation
    ...
    ai-inference.ConfigMap.model-sync-script.data."sync.py" = ''
      ...
      CURATED = """
      qwen/qwen3.5-397b-a17b|primary|Qwen3 Coder 480B A35B orchestrator
      deepseek-ai/deepseek-v4-flash|fast|DeepSeek V4 Flash fast agentic
      qwen/qwen3.5-flash-02-23|fast|Qwen3.5 9B mid-tier reasoning
      qwen3.5-2b-awq|fast|Qwen3.5 2B AWQ ultra-fast
      ...
      omp = {
          ...
          "modelRoles": {
              "default": "deepseek-ai/deepseek-v4-flash",  # 1x quota, always cheap
      ...
      # Generate Pi YAML (NO plaintext API key — Pi reads OPENCODE_API_KEY from env)
      pi_lines.extend([
          "providers:",
          "  gateway:",
          "    type: openai-compatible",
