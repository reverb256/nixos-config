...
let
  ...
  kryptexPools = {
    rvn  = { host = "rvn-us.kryptex.network";  port = 7031; tlsPort = 8031; algo = "kawpow";   coinFlag = "--coin rvn";   walletFmt = "${wallet}"; };
    cfx  = { host = "cfx-us.kryptex.network";  port = 7027; tlsPort = 8027; algo = "octopus";  coinFlag = "--coin cfx";   walletFmt = "${wallet}"; };
    erg  = { host = "erg-us.kryptex.network";  port = 7021; tlsPort = null;  algo = "autolykos2"; coinFlag = "";           walletFmt = "${wallet}"; };
    nexa = { host = "nexa-us.kryptex.network"; port = 7026; tlsPort = null;  algo = "nexapow";  coinFlag = "";             walletFmt = "${wallet}"; };
    xna  = { host = "xna-us.kryptex.network";  port = 7024; tlsPort = null;  algo = "kawpow";   coinFlag = "--coin xna";   walletFmt = "${wallet}"; };
    iron = { host = "iron-us.kryptex.network"; port = 7050; tlsPort = null;  algo = "fishhash"; coinFlag = "";             walletFmt = "${wallet}"; };
    xel  = { host = "xel-us.kryptex.network";  port = 7055; tlsPort = null;  algo = "xelishashv3"; coinFlag = "";          walletFmt = "${wallet}"; };
  };
              ...
              spec = {
                ...
                containers = {
                  ...
                  switcher = {
                    ...
                    volumeMounts = {
                      _namedlist = true;
                      script = { mountPath = "/opt/profit-switcher.py"; subPath = "profit-switcher.py"; };
                      kubeconfig = { mountPath = "/etc/rancher/k3s/k3s.yaml"; readOnly = true; };
                    };
                  };
                };
                volumes = {
