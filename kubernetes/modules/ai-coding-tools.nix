        ...
        template = {
          spec = {
            ...
            containers = [{
              ...
              ''];
              volumeMounts = [
                { name = "host-home"; mountPath = "/host-home"; readOnly = true; }
                { name = "pvc-home"; mountPath = "/pvc-home"; }
              ];
            }];
            volumes = [
              { name = "host-home"; hostPath = { path = "/home/j_kro"; type = "Directory"; }; }
              { name = "pvc-home"; persistentVolumeClaim.claimName = "ai-coding-configs"; }
            ];
            restartPolicy = "Never";
          };
        };
          ...
          spec = {
            ...
            containers = {
              ...
              claude-code = {
                ...
                volumeMounts = { _namedlist = true; home-dir = { mountPath = "/home/j_kro"; }; };
                livenessProbe = {
              ...
              metrics = {
                ...
                command = [ "/bin/sh" "-c" ''
                  ...
                  "
                ''];
                env = { _namedlist = true; HOME.value = "/home/j_kro"; };
                ports = [{ containerPort = 9090; name = "metrics"; protocol = "TCP"; }];
                resources = {
                  requests = { cpu = "50m"; memory = "64Mi"; };
                  limits = { cpu = "100m"; memory = "128Mi"; };
                };
                volumeMounts = { _namedlist = true; home-dir = { mountPath = "/home/j_kro"; readOnly = true; }; };
              };
            };
            volumes = {
              _namedlist = true;
