...
graph TD
    ...
    subgraph "Local Network (10.1.1.0/24)"
        ...
        Router --> Forge[forge - 10.1.1.130<br/>GPU Compute Worker<br/>2x RTX 4060 + 2x RX 5700 XT]
...
| **nexus** | 10.1.1.120 | AIStor/Storage | 24 cores (Ryzen 9 3900X) | 32GB | 2x RTX 3060 Ti | Distributed Builds, AIStor Object Storage |
...
**Technical Specifications:**
- **Endpoint**: `http://10.1.1.120:9000` (internal network only)
