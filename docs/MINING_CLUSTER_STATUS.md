...
### 👁️ Sentry (10.1.1.140) - Monitoring Node
- **Hardware:** Ryzen 1700 (8 cores)
- **Services:**
  - ✅ CPU Mining (Ryzen 1700)
- **Status:** Fully operational

### 🔥 Forge (10.1.1.130) - GPU Mining Rig
...
- **Wallet:** `krxXVNVMM7.{hostname}` (per-node identification)
