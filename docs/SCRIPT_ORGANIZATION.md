...
├── -aistor-workflows.py  #  AIStor workflows
...
├── test--tailscale.sh  # Test  with Tailscale
├── test--workflows.py  # Test  workflows
...
mv scripts/validate--setup.sh scripts/maintenance/
...
# Testing
mv scripts/-aistor-workflows.py scripts/testing/
mv scripts/test--tailscale.sh scripts/testing/
mv scripts/test--workflows.py scripts/testing/
```
...
# Testing
test-:
	cd scripts/testing && ./test--workflows.py

test-tailscale:
	cd scripts/testing && ./test--tailscale.sh
```
