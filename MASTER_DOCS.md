...
|------|----|------|-------|----------|--------|
| localhost (zephyr) | 10.1.1.110 | 8 | 4 | cuda | ✅ Active |
| nexus | 10.1.1.120 | 6 | 3 | cuda | ✅ Active |
| forge | 10.1.1.130 | 3 | 1 | cuda | ✅ Active |
| sentry | 10.1.1.140 | 4 | 2 | kvm | ✅ Active |
...
- **Subnet Routing**: 10.1.1.0/24 network advertisement
...
### Overview
S3-compatible object storage for AI/ML workloads on nexus (10.1.1.120).
