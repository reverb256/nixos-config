...
# 192.168.100.X - Build Server (24 cores, 2x RTX 3060 Ti)
{pkgs, ...}: {
  imports = [
  ...
  services.minio = {
    enable = true;
    listenAddress = "192.168.100.X:9000";
    consoleAddress = "192.168.100.X:9001";
    region = "us-east-1";
  ...
  environment.variables = {
    ...
    AISTOR_MCP_ENDPOINT = "http://192.168.100.X:9000";
    # S3 API endpoint (current)
    AISTOR_S3_ENDPOINT = "http://192.168.100.X:9000";
