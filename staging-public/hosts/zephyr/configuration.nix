...
# 192.168.100.X - Master Workstation (32 cores, RTX 3090)
{
  pkgs,
  config,
  ...
  ...
  # ============================================================================
  # SECURITY: Only accessible via Tailscale VPN (100.YYY.YYY.YYY)
  ...
  services.openclaw.declarative = {
    ...
    gatewayBind = "100.YYY.YYY.YYY";  # Tailscale IP - blocks public access
  ...
  networking.firewall = {
    ...
    # Port 18789 accessible ONLY via Tailscale interface (100.YYY.YYY.YYY)
