...
- **Zephyr (192.168.100.X):** SSH (22), Steam ports, WiVRn (9757, UDP range)
- **Nexus (192.168.100.X):** SSH (22) only
- **Forge (192.168.100.X):** SSH (22) only  
- **Sentry (192.168.100.X):** SSH (22) only
