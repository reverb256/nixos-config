...
graph TD
    ...
    subgraph "Local Network (192.168.100.X/24)"
        ...
        Router --> Forge[forge - 192.168.100.X<br/>Mining/Build Worker<br/>2x RTX 4060 + 2x RX 5700 XT]
...
|------|------------|------|-----------|--------|-----|---------|
| **zephyr** | 192.168.100.X | Master Node | 32 | 64GB | RTX 3090 | VR Gaming, Development, Build Coordination |
| **nexus** | 192.168.100.X | Build/Backup | 24 | 32GB | 2x RTX 3060 Ti | Distributed Builds, AIStor Storage |
| **forge** | 192.168.100.X | GPU Compute | 6 | 32GB | 2x RTX 4060 + 2x RX 5700 XT | GPU Compute, Mining |
| **sentry** | 192.168.100.X | Monitoring | 8 | 32GB | RX 5600 XT | Monitoring, Light Builds |
...
│  AIStor Server (MinIO)                                       │
├─────────────────────────────────────────────────────────────┤
│  • Single-node deployment on nexus (192.168.100.X:9000)         │
│  • S3-compatible API                                        │
│  • UI: http://192.168.100.X:9001                               │
│  • Buckets:                                                 │
...
**Rationale**:
- All services communicate over 192.168.100.X/24
