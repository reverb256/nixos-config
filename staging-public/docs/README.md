...
| **nexus** | 192.168.100.X | Build/Backup | 24 cores (Ryzen 9 3900X) | 32GB | 2x RTX 3060 Ti | Distributed Builds, Backup Storage |
...
Internet ── Router (192.168.100.X)
                   ...
                   ├── nexus  (192.168.100.X) - Build/Backup Server
                   ├── forge  (192.168.100.X) - Build/Development Server
                   └── sentry (192.168.100.X) - Monitoring Server
```
