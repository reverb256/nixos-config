...
echo "  - nexus (192.168.100.X): 6 jobs, speed=3, features=cuda"
echo "  - forge (192.168.100.X): 3 jobs, speed=1, features=cuda"
echo "  - sentry (192.168.100.X): 4 jobs, speed=2, features=kvm"
echo ""
