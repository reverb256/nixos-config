...
with lib; {
      ...
      stub-zone = [
        {
          ...
          stub-addr = "100.YYY.YYY.YYY"; # Tailscale DNS server
        }
      ];
  ...
  services.fail2ban = {
    ...
    ignoreIP = [
      "127.0.0.1"
      "192.168.100.X/24"
      "100.YYY.YYY.YYY"  # zephyr Tailscale
      "100.YYY.YYY.YYY"  # nexus Tailscale
      "100.YYY.YYY.YYY"  # forge Tailscale
      "100.YYY.YYY.YYY"  # sentry Tailscale
    ];
  };
