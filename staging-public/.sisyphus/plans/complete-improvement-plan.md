  ...
  config = ''
    ...
    scrape_configs:
      - job_name: 'nix-cluster'
        static_configs:
          - targets: ['192.168.100.X:9090', '192.168.100.X:9090', '192.168.100.X:9090', '192.168.100.X:9090']
      
      - job_name: 'node-exporter'
        static_configs:
          - targets: ['192.168.100.X:9100', '192.168.100.X:9100', '192.168.100.X:9100', '192.168.100.X:9100']
...
# Main execution
check_node "WORKER_X" "192.168.100.X"
check_node "WORKER_X" "192.168.100.X"
check_node "WORKER_X" "192.168.100.X"
check_node "WORKER_X" "192.168.100.X"
...
services.haproxy = {
  ...
  config = ''
    ...
    backend nix_nodes
      balance roundrobin
      server zephyr 192.168.100.X:8080 check
      server nexus 192.168.100.X:8080 check
      server forge 192.168.100.X:8080 check
      server sentry 192.168.100.X:8080 check
  '';
};
```
...
curl http://192.168.100.X:4068/summary  # Should fail (external)
