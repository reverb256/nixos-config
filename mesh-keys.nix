[
  # j_kro@zephyr — primary key on all cluster hosts
  "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEvekxGk1YR/eF8llVmNk3C59BtgB+9DNvxLy2WjPEyb j_kro@zephyr"

  # j_kro@nexus — unique key
  "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIU9isFAwjVECiYVB0BoiAc1r5EXG5WbqgYErIrlj0VB j_kro@nexus"

  # j_kro@forge — unique key
  "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEvJbf9R6GIcuuUUIOqwHdSZaRRty/vXuYu9mn+k3Cvt j_kro@forge"

  # j_kro@krash3 — unique key for Windows/WSL
